...
2. `docs/requirements_baseline_v0.4.md`：当前主线需求冻结版本（学生就业-专业对口）。
3. `docs/architecture.md`：看分层和数据流。
4. `docs/refactor_todolist_v0.4.md`：学生就业-专业对口主线重构清单（当前执行基线）。
5. `docs/ordered_todo_v0.2.md`：v0.2 重构与优化执行清单（历史记录，含已下线能力）。
6. `docs/ordered_todo.md`：v0.1 路线和历史里程碑。
7. `docs/functional_design_flowchart.md`：看功能模块端到端流程图。
8. `docs/defense_simplified_flowchart.md`：答辩展示用简化业务流程图。
